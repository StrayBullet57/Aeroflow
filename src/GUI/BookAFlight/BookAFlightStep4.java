...
public class BookAFlightStep4 {
    ...
    public static JPanel getPanel(MainContent main) {
        ...
        redSquare.add(Box.createVerticalStrut(12));

        redSquare.add(createFieldLabel("Route"));
        redSquare.add(createValueLabel(originText + " → " + destinationText));
        redSquare.add(Box.createVerticalStrut(12));

        redSquare.add(createFieldLabel("Departure Date"));
        redSquare.add(createValueLabel(departureDateText));
        redSquare.add(Box.createVerticalStrut(12));

        redSquare.add(createFieldLabel("Departure Time"));
        redSquare.add(createValueLabel(departureTimeText));
        redSquare.add(Box.createVerticalStrut(12));

        redSquare.add(createFieldLabel("Arrival Date"));
        redSquare.add(createValueLabel(arrivalDateText));
        redSquare.add(Box.createVerticalStrut(12));

        redSquare.add(createFieldLabel("Arrival Time"));
        redSquare.add(createValueLabel(arrivalTimeText));
        redSquare.add(Box.createVerticalStrut(12));
